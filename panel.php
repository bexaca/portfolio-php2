...
$sql = "INSERT INTO slika VALUES(null,:ime,:putanja)";
$stmt = $konekcija->prepare($sql);
$stmt->bindParam(":ime", $ime);
...
<body>
    ...
    <div class="image__change panel-form">
        <h1>Add picture</h1>
    ...
    <div class="hero-header__change panel-form">
    ...
    <div class="skills__change panel-form">
        <div class="tabela">
            <div style="width: max-content; margin:0 auto;">
                <table border="1 px solid" style="background-color:darkslategrey;">
                    <tr>
    ...
    <div class="contact__change panel-form">
        <div class="tabela">
            <div style="width: max-content; margin:0 auto;">
                <table border="1 px solid" style="background-color:darkslategrey;">
                    <tr>
    ...
    <h1>Poll active</h1>
    <form class="panel-form" name="poll" action="control.php?page=panel" method="POST">
    ...
    <input type="submit" name="poll_change" class="sblog btnposalji" value="Change">
